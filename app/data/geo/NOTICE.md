...
Bureau's Core Based Statistical Area delineation files (public domain), as
republished in the NBER county crosswalk
(https://data.nber.org/cbsa-csa-fips-county-crosswalk/).
